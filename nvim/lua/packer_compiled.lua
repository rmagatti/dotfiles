...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-vsnip", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-npm", "cmp-buffer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lightbulb', 'nvim-ts-context-commentstring', 'fzf', 'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-lspinstall', 'alternate-toggler'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
