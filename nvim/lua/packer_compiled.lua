...
vim.cmd [[nnoremap <silent> <leader>du <cmd>lua require("packer.load")({'nvim-dap-ui'}, { keys = "<lt>leader>du", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'alternate-toggler', 'fzf', 'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-lightbulb', 'nvim-lspinstall'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
