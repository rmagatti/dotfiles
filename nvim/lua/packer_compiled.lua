...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'nvim-lspinstall', 'fzf', 'alternate-toggler', 'nvim-lightbulb', 'targets.vim', 'nvim-treesitter-textsubjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
