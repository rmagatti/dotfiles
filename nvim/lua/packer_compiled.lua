...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-vsnip", "cmp-nvim-lua", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-npm" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'indent-blankline.nvim', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'targets.vim', 'nvim-lightbulb', 'fzf', 'alternate-toggler', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
