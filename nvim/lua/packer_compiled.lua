...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-lspinstall', 'fzf', 'nvim-treesitter-textsubjects', 'alternate-toggler', 'nvim-lightbulb', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
