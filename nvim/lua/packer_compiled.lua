...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-vsnip", "cmp-cmdline", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring', 'nvim-lightbulb', 'nvim-treesitter-textobjects', 'alternate-toggler'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
