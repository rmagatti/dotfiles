...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "cmp-npm", "cmp-vsnip", "cmp-path" },
  ...
  ["refactoring.nvim"] = {
    config = { "\27LJ\2\n∏\1\0\0\6\0\t\0\f6\0\0\0'\2\1\0B\0\2\0016\0\2\0009\0\3\0009\0\4\0'\2\5\0'\3\6\0'\4\a\0005\5\b\0B\0\5\1K\0\1\0\1\0\3\fnoremap\2\texpr\2\vsilent\2)<cmd>call v:lua.list_refactors()<CR>\15<leader>re\6v\20nvim_set_keymap\bapi\bvim\25rmagatti.refactoring\frequire\0" },
    keys = { { "v", "<leader>re" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.vim', 'nvim-autopairs', 'nvim-cmp', 'indent-blankline.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lightbulb', 'fzf', 'nvim-ts-context-commentstring', 'alternate-toggler', 'nvim-treesitter-textsubjects', 'targets.vim', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
