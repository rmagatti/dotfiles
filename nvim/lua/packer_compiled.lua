...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-vsnip", "cmp-path", "cmp-rg", "cmp-cmdline", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-ts-context-commentstring', 'alternate-toggler', 'nvim-lightbulb', 'targets.vim', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
