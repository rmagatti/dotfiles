...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-path", "cmp-vsnip", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-lsp" },
  ...
  ["telescope.nvim"] = {
    ...
    keys = { { "n", "<C-p>" }, { "n", "<leader>ps" }, { "n", "<leader>pg" }, { "n", "<leader>pl" }, { "n", "<leader>b" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lspinstall', 'targets.vim', 'alternate-toggler', 'fzf', 'nvim-lightbulb', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
