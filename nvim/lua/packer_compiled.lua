...
_G.packer_plugins = {
  ...
  ["goto-preview"] = {
    config = { "\27LJ\2\n¶\1\0\0\3\0\a\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\4\0009\0\5\0'\2\6\0B\0\2\1K\0\1\0\26nnoremap <C-h> <C-w>w\bcmd\bvim\1\0\4\22resizing_mappings\2\ndebug\1\rwinblend\3\n\21default_mappings\2\nsetup\17goto-preview\frequire\0" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-lsp-handlers.nvim", "telescope-packer.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-lspinstall', 'nvim-treesitter-textobjects', 'targets.vim', 'fzf', 'alternate-toggler', 'nvim-lightbulb'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'friendly-snippets', 'nvim-compe', 'vim-vsnip-integ', 'vim-vsnip'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
