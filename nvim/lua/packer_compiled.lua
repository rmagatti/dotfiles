...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-rg", "cmp-nvim-lsp", "cmp-vsnip", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-cmdline" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'alternate-toggler', 'nvim-treesitter-textsubjects', 'fzf', 'nvim-lightbulb'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'indent-blankline.nvim', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
