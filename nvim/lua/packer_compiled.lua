...
_G.packer_plugins = {
  ["alternate-toggler"] = {
    config = { "\27LJ\2\nﬁ\1\0\0\5\0\b\0\f6\0\0\0009\0\1\0009\0\2\0'\2\3\0'\3\4\0'\4\5\0B\0\4\0016\0\0\0009\0\6\0'\2\a\0B\0\2\1K\0\1\0002 let g:at_custom_alternates = {'===': '!=='} \bcmdX<cmd>lua require('alternate-toggler').toggleAlternate(vim.fn.expand('<cword>'))<CR>\20<leader><space>\6n\bset\vkeymap\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\n¥\1\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\22\bcpp\2\vcsharp\2\bphp\2\ac#\2\bc++\2\6c\2\tyaml\2\ash\2\ajs\2\15typescript\2\thtml\2\vpython\2\apy\2\acs\2\trust\2\blua\2\bcss\2\6*\1\15javascript\2\truby\2\bvim\2\tjson\2\22copilot_filetypes\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["lightspeed.nvim"] = {
    config = { "\27LJ\2\nÖ\2\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\a+match_only_the_start_of_same_char_seqs\2\21limit_ft_matches\3\5\30full_inclusive_prefix_key\n<c-x>\24jump_to_first_match\2)jump_on_partial_input_safety_timeout\3ê\3\27highlight_unique_chars\1\25grey_out_search_area\2\nsetup\15lightspeed\frequire\0" },
  ...
  ["lsp-trouble.nvim"] = {
    commands = { "Trouble" },
    config = { "\27LJ\2\nr\0\0\3\0\6\0\n6\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\3\0009\0\4\0'\2\5\0B\0\2\1K\0\1\0)nnoremap <leader>xx <cmd>Trouble<CR>\bcmd\bvim\nsetup\ftrouble\frequire\0" },
    keys = { { "", "<leader>xx" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-npm", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-vsnip", "cmp-path", "cmp-cmdline" },
  ...
  ["nvim-toggleterm.lua"] = {
    ...
    config = { "\27LJ\2\nU\0\1\2\0\3\0\f9\1\0\0\a\1\1\0X\1\3Ä)\1\25\0L\1\2\0X\1\5Ä9\1\0\0\a\1\2\0X\1\2Ä)\1P\0L\1\2\0K\0\1\0\rvertical\15horizontal\14directionˇ\4\1\0\6\0\22\00036\0\0\0'\2\1\0B\0\2\0029\1\2\0005\3\3\0003\4\4\0=\4\5\3B\1\2\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\n\0'\5\v\0B\1\4\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\f\0'\5\r\0B\1\4\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\14\0'\5\15\0B\1\4\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\16\0'\5\17\0B\1\4\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\18\0'\5\19\0B\1\4\0016\1\6\0009\1\a\0019\1\b\1'\3\t\0'\4\20\0'\5\21\0B\1\4\1K\0\1\0.<cmd>4ToggleTerm direction='vertical'<CR>\15<leader>4v.<cmd>3ToggleTerm direction='vertical'<CR>\15<leader>3v.<cmd>2ToggleTerm direction='vertical'<CR>\15<leader>2v0<cmd>4ToggleTerm direction='horizontal'<CR>\15<leader>4s0<cmd>3ToggleTerm direction='horizontal'<CR>\15<leader>3s0<cmd>2ToggleTerm direction='horizontal'<CR>\15<leader>2s\6n\bset\vkeymap\bvim\tsize\0\1\0\3\17open_mapping\n<C-\\>\20start_in_insert\1\20insert_mappings\2\nsetup\15toggleterm\frequire\0" },
  ...
  ["refactoring.nvim"] = {
    config = { "\27LJ\2\n¶\1\0\0\6\0\t\0\f6\0\0\0'\2\1\0B\0\2\0016\0\2\0009\0\3\0009\0\4\0'\2\5\0'\3\6\0'\4\a\0005\5\b\0B\0\5\1K\0\1\0\1\0\2\texpr\2\vsilent\2)<cmd>call v:lua.list_refactors()<CR>\15<leader>re\6v\bset\vkeymap\bvim\25rmagatti.refactoring\frequire\0" },
    keys = { { "v", "<leader>re" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-packer.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-fugitive"] = {
    ...
    config = { "\27LJ\2\nè\2\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0Ô\1        nnoremap <silent> <leader>gb :<C-u>Git blame<CR>\n        nnoremap <silent> gb :<C-u>Git blame<CR>\n        nnoremap <leader>gd :Gvdiffsplit!<CR>\n        nnoremap gj :diffget //2<CR>\n        nnoremap g; :diffget //3<CR>\n        \bcmd\bvim\0" },
    keys = { { "n", "gb" }, { "n", "<leader>gd" }, { "n", "<leader>gb" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
try_loadstring("\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17rmagatti.igs\frequire\0", "config", "igs.nvim")
...
vim.cmd [[nnoremap <silent> gb <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "gb", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-vsnip', 'friendly-snippets'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-autopairs', 'copilot.vim', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'fzf', 'nvim-treesitter-textobjects', 'alternate-toggler', 'nvim-lightbulb', 'nvim-treesitter-textsubjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
