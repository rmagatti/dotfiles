...
_G.packer_plugins = {
  ...
  ["goto-preview"] = {
    config = { "\27LJ\2\n¶\1\0\0\3\0\a\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\4\0009\0\5\0'\2\6\0B\0\2\1K\0\1\0\26nnoremap <C-h> <C-w>w\bcmd\bvim\1\0\4\ndebug\1\21default_mappings\2\22resizing_mappings\2\rwinblend\3\n\nsetup\17goto-preview\frequire\0" },
    loaded = true,
    path = "/Users/ronnieandrewmagatti/.local/share/nvim/site/pack/packer/start/goto-preview"
  },
  ["impatient.nvim"] = {
    loaded = true,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lightbulb', 'fzf', 'alternate-toggler', 'nvim-treesitter-textsubjects', 'targets.vim', 'nvim-lspinstall', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
