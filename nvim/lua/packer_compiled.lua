...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-vsnip", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-npm", "cmp-rg" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'fzf', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-lightbulb', 'alternate-toggler', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-autopairs', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
