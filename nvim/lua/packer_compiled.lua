...
_G.packer_plugins = {
  ...
  ["goto-preview"] = {
    config = { "\27LJ\2\n¶\1\0\0\3\0\a\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\4\0009\0\5\0'\2\6\0B\0\2\1K\0\1\0\26nnoremap <C-h> <C-w>w\bcmd\bvim\1\0\4\ndebug\1\22resizing_mappings\2\21default_mappings\2\rwinblend\3\n\nsetup\17goto-preview\frequire\0" },
  ...
  ["lightspeed.nvim"] = {
    config = { "\27LJ\2\nÖ\2\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\a\21limit_ft_matches\3\5\27highlight_unique_chars\1\30full_inclusive_prefix_key\n<c-x>\24jump_to_first_match\2)jump_on_partial_input_safety_timeout\3ê\3\25grey_out_search_area\2+match_only_the_start_of_same_char_seqs\2\nsetup\15lightspeed\frequire\0" },
  ...
  ["nvim-neoclip.lua"] = {
    config = { "\27LJ\2\nü\1\0\0\3\0\6\0\n6\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\3\0009\0\4\0'\2\5\0B\0\2\1K\0\1\0Vnnoremap <leader>y <cmd>lua require('telescope').extensions.neoclip.default()<CR>\bcmd\bvim\nsetup\fneoclip\frequire\0" },
    keys = { { "n", "<leader>y" } },
    loaded = false,
    needs_bufread = false,
  ...
  ["refactoring.nvim"] = {
    config = { "\27LJ\2\n∏\1\0\0\6\0\t\0\f6\0\0\0'\2\1\0B\0\2\0016\0\2\0009\0\3\0009\0\4\0'\2\5\0'\3\6\0'\4\a\0005\5\b\0B\0\5\1K\0\1\0\1\0\3\fnoremap\2\vsilent\2\texpr\2)<cmd>call v:lua.list_refactors()<CR>\15<leader>re\6v\20nvim_set_keymap\bapi\bvim\25rmagatti.refactoring\frequire\0" },
    keys = { { "v", "<leader>re" } },
    loaded = false,
    needs_bufread = false,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-packer.nvim", "telescope-lsp-handlers.nvim" },
    commands = { "Telescope" },
    config = { "\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23rmagatti.telescope\frequire\0" },
    keys = { { "n", "<C-p>" }, { "n", "<leader>ps" }, { "n", "<leader>pg" }, { "n", "<leader>pl" } },
    loaded = false,
    needs_bufread = true,
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Cheat lua require("packer.load")({'cheat.sh-vim'}, { cmd = "Cheat", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file CheatPaste lua require("packer.load")({'cheat.sh-vim'}, { cmd = "CheatPaste", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Bufferize lua require("packer.load")({'bufferize.vim'}, { cmd = "Bufferize", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Grepper lua require("packer.load")({'vim-grepper'}, { cmd = "Grepper", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined <Plug>(GrepperOperator) ++once lua require"packer.load"({'vim-grepper'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TodoQuickFix lua require("packer.load")({'todo-comments.nvim'}, { cmd = "TodoQuickFix", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ToggleTermOpenAll lua require("packer.load")({'nvim-toggleterm.lua'}, { cmd = "ToggleTermOpenAll", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ToggleTermCloseAll lua require("packer.load")({'nvim-toggleterm.lua'}, { cmd = "ToggleTermCloseAll", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-compe', 'vim-vsnip-integ', 'vim-vsnip', 'friendly-snippets'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'alternate-toggler', 'nvim-treesitter-textobjects', 'nvim-lightbulb', 'targets.vim', 'nvim-lspinstall', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-ts-context-commentstring'}, { event = "BufEnter *" }, _G.packer_plugins)]]
