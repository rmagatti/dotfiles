...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-vsnip", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'alternate-toggler', 'nvim-lightbulb', 'nvim-ts-context-commentstring', 'fzf', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
