...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-vsnip", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-npm", "cmp-cmdline" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-autopairs', 'indent-blankline.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'nvim-ts-rainbow', 'nvim-lightbulb', 'nvim-treesitter-textobjects', 'alternate-toggler', 'nvim-ts-context-commentstring', 'nvim-treesitter-textsubjects', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
