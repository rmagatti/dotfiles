...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-vsnip", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp-nvim-lsp", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'alternate-toggler', 'fzf', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-lightbulb'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
