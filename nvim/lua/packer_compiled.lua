...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-npm", "cmp-nvim-lua", "cmp-vsnip", "cmp-rg" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring', 'fzf', 'nvim-treesitter-textobjects', 'nvim-lightbulb', 'nvim-ts-rainbow', 'alternate-toggler'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
