...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-vsnip", "cmp-npm", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["telescope-ui-select.nvim"] = {
    config = { "\27LJ\2\nñ\1\0\0\a\0\b\0\0156\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\0016\0\4\0006\2\5\0009\2\6\0026\4\0\0'\6\a\0B\4\2\0A\2\0\0A\0\0\1K\0\1\0\26telescope._extensions\finspect\bvim\nprint\14ui-select\19load_extension\14telescope\frequire\0" },
    load_after = {
      ["telescope.nvim"] = true
    },
    loaded = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'copilot.vim', 'nvim-autopairs', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'nvim-treesitter-textobjects', 'alternate-toggler', 'targets.vim', 'nvim-lightbulb', 'nvim-lspinstall', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
