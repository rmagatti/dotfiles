...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\n¥\1\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\22\6c\2\bvim\2\bphp\2\trust\2\ac#\2\thtml\2\tjson\2\apy\2\bcpp\2\15typescript\2\6*\1\blua\2\truby\2\ajs\2\15javascript\2\bcss\2\tyaml\2\acs\2\vcsharp\2\ash\2\vpython\2\bc++\2\22copilot_filetypes\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-npm", "cmp-rg", "cmp-path", "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "cmp-nvim-lsp" },
  ...
  ["vim-fugitive"] = {
    ...
    keys = { { "n", "gb" }, { "n", "<leader>gd" }, { "n", "<leader>gb" }, { "n", "<leader>hp" }, { "n", "<leader>hs" }, { "n", "<leader>hu" }, { "n", "<leader>hr" }, { "n", "<leader>hR" }, { "n", "<leader>hp" }, { "n", "<leader>hb" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'fzf', 'nvim-ts-rainbow', 'nvim-lightbulb', 'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'alternate-toggler', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.vim', 'indent-blankline.nvim', 'nvim-autopairs', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
