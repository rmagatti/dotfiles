...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-buffer", "cmp-vsnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "cmp-rg" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'alternate-toggler', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'nvim-lightbulb', 'fzf', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'nvim-autopairs', 'nvim-cmp', 'indent-blankline.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
