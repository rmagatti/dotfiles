...
_G.packer_plugins = {
  ...
  ["lightspeed.nvim"] = {
    config = { "\27LJ\2\nÖ\2\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\a\25grey_out_search_area\2+match_only_the_start_of_same_char_seqs\2\24jump_to_first_match\2\21limit_ft_matches\3\5\30full_inclusive_prefix_key\n<c-x>)jump_on_partial_input_safety_timeout\3ê\3\27highlight_unique_chars\1\nsetup\15lightspeed\frequire\0" },
  ...
  ["refactoring.nvim"] = {
    config = { "\27LJ\2\n∏\1\0\0\6\0\t\0\f6\0\0\0'\2\1\0B\0\2\0016\0\2\0009\0\3\0009\0\4\0'\2\5\0'\3\6\0'\4\a\0005\5\b\0B\0\5\1K\0\1\0\1\0\3\vsilent\2\texpr\2\fnoremap\2)<cmd>call v:lua.list_refactors()<CR>\15<leader>re\6v\20nvim_set_keymap\bapi\bvim\25rmagatti.refactoring\frequire\0" },
    keys = { { "v", "<leader>re" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lspinstall', 'nvim-lightbulb', 'nvim-treesitter-textsubjects', 'fzf', 'targets.vim', 'alternate-toggler', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
