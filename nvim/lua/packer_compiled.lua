...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-rg", "cmp-path", "cmp-vsnip", "cmp-buffer", "cmp-cmdline" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'indent-blankline.nvim', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'igs.nvim', 'alternate-toggler', 'fzf', 'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
