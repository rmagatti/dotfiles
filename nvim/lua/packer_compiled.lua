...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-cmdline", "cmp-vsnip", "cmp-rg", "cmp-nvim-lsp" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-lightbulb', 'alternate-toggler', 'nvim-ts-rainbow', 'nvim-treesitter-textobjects', 'nvim-ts-context-commentstring', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
