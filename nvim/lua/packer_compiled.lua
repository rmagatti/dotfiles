...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-vsnip", "cmp-npm", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-lightbulb', 'nvim-treesitter-textsubjects', 'nvim-ts-rainbow', 'fzf', 'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'alternate-toggler'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
