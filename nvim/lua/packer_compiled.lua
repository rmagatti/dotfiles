...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-npm", "cmp-nvim-lsp", "cmp-cmdline", "cmp-path", "cmp-vsnip", "cmp-nvim-lua", "cmp-buffer" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-cmp', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-lightbulb', 'nvim-treesitter-textobjects', 'targets.vim', 'alternate-toggler', 'fzf', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
