...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-nvim-lsp", "cmp-vsnip", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-rg" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'targets.vim', 'fzf', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter-textobjects', 'alternate-toggler', 'nvim-lightbulb'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
