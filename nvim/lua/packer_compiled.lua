...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\n¥\1\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0\22\bcss\2\ash\2\apy\2\trust\2\bc++\2\15javascript\2\bvim\2\tjson\2\bphp\2\blua\2\6c\2\6*\1\acs\2\vpython\2\tyaml\2\ac#\2\vcsharp\2\bcpp\2\ajs\2\15typescript\2\truby\2\thtml\2\22copilot_filetypes\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-cmdline", "cmp-buffer", "cmp-rg", "cmp-path", "cmp-vsnip" },
...
pcall(vim.api.nvim_create_user_command, 'JsDoc', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-jsdoc'}, { cmd = 'JsDoc' }, _G.packer_plugins)
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'igs.nvim', 'nvim-treesitter-textobjects', 'alternate-toggler', 'fzf', 'nvim-treesitter-textsubjects', 'targets.vim', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
