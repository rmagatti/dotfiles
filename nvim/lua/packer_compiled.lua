...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-path", "cmp-vsnip", "cmp-cmdline", "cmp-nvim-lua", "cmp-npm", "cmp-nvim-lsp" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-cmp', 'indent-blankline.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'fzf', 'targets.vim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'alternate-toggler', 'nvim-lightbulb'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
