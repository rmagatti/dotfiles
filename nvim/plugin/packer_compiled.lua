...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'targets.vim', 'nvim-lightbulb', 'nvim-lspinstall', 'alternate-toggler', 'fzf', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
