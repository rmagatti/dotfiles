...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspinstall', 'nvim-treesitter-textobjects', 'alternate-toggler', 'targets.vim', 'nvim-lightbulb', 'nvim-treesitter-textsubjects', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-vsnip-integ', 'nvim-compe', 'friendly-snippets', 'vim-vsnip'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
