...
_G.packer_plugins = {
  ...
  firenvim = {
    config = { "\27LJ\2\n’\3\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0µ\3        let g:firenvim_config = {'globalSettings': {'alt': 'all', },'localSettings': {'.*': {'cmdline': 'neovim','content': 'text','priority': 0,'selector': 'textarea','takeover': 'never'}}}\n        let fc = g:firenvim_config['localSettings']\n        let fc['https?://docs.google.com/spreadsheets/'] = { 'takeover': 'never', 'priority': 1 }\n        let fc['https?://meet.google.com/'] = { 'takeover': 'never', 'priority': 1 }\n      \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/ronnieandrewmagatti/.local/share/nvim/site/pack/packer/opt/firenvim"
  },
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["goto-preview"] = {
    config = { "\27LJ\2\nb\0\2\t\0\a\0\n6\2\0\0009\2\1\0029\2\2\2\18\4\0\0'\5\3\0'\6\4\0'\a\5\0005\b\6\0B\2\6\1K\0\1\0\1\0\1\fnoremap\2\v:q<CR>\6q\6n\24nvim_buf_set_keymap\bapi\bvim´\1\1\0\4\0\t\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0003\3\4\0=\3\5\2B\0\2\0016\0\6\0009\0\a\0'\2\b\0B\0\2\1K\0\1\0\26nnoremap <C-h> <C-w>w\bcmd\bvim\19post_open_hook\0\1\0\3\21default_mappings\2\ndebug\1\rwinblend\3\n\nsetup\17goto-preview\frequire\0" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-lspinstall', 'targets.vim', 'telescope-lsp-handlers.nvim', 'indent-blankline.nvim', 'vim-indent-object', 'alternate-toggler', 'nvim-lightbulb', 'fzf', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-vsnip-integ', 'telescope-fzf-native.nvim', 'nvim-lspconfig', 'friendly-snippets', 'nvim-autopairs', 'nvim-compe', 'vim-vsnip'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
