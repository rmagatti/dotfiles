...
_G.packer_plugins = {
  ...
  ["refactoring.nvim"] = {
    config = { "\27LJ\2\n4\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\25rmagatti.refactoring\frequire\0" },
    keys = { { "v", "<leader>re" } },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-lightbulb', 'alternate-toggler', 'nvim-lspinstall'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-vsnip', 'vim-vsnip-integ', 'friendly-snippets', 'nvim-compe'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
